...
function Storage(dim::MechanismDimensions1160, H::Int, T=Float64)
...
function record!(storage::Storage116{T,H}, mechanism::Mechanism1160{T,D,NB,NC}, i::Int) where {T,H,D,NB,NC}
