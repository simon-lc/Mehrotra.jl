...
function Storage(dim::MechanismDimensions1140, H::Int, T=Float64)
...
function record!(storage::Storage116{T,H}, mechanism::Mechanism1140{T,D,NB,NC}, i::Int) where {T,H,D,NB,NC}
