...
# Continuation
################################################################################
function reset!(mechanism::Mechanism1140; residual_tolerance=1e-4, complementarity_tolerance=1e-3)
...
function continuation_callback!(solver::IterativeLQR.Solver, mechanism::Mechanism1140; ρ=1.5, visualize=false)
    msolver = mechanism.solver
    moptions = msolver.options
