...
include("quasistatic_dynamics/body.jl")
include("quasistatic_dynamics/poly_halfspace.jl")
include("quasistatic_dynamics/poly_poly.jl")
include("quasistatic_dynamics/poly_sphere.jl")
include("quasistatic_dynamics/sphere_halfspace.jl")
include("quasistatic_dynamics/sphere_sphere.jl")
